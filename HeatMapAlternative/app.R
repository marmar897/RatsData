...
df11 <- read.csv("ratsComplete11_8.csv")
df11$Zip<-as.character(df11$Zip)

df12 <- read.csv("ratsComplete12_8.csv")
df12$Zip<-as.character(df12$Zip)

df13 <- read.csv("ratsComplete13_8.csv")
df13$Zip<-as.character(df13$Zip)

df14 <- read.csv("ratsComplete14_8.csv")
df14$Zip<-as.character(df14$Zip)

df15 <- read.csv("ratsComplete15_8.csv")
df15$Zip<-as.character(df15$Zip)

df16 <- read.csv("ratsComplete16_8.csv")
df16$Zip<-as.character(df16$Zip)

df17 <- read.csv("ratsComplete17_8.csv")
df17$Zip<-as.character(df17$Zip)

df18 <- read.csv("ratsComplete18_8.csv")
df18$Zip<-as.character(df18$Zip)

df19 <- read.csv("ratsComplete19_8.csv")
df19$Zip<-as.character(df19$Zip)

df20 <- read.csv("ratsComplete20_8.csv")
df20$Zip<-as.character(df20$Zip)

df21 <- read.csv("ratsComplete21_8.csv")
