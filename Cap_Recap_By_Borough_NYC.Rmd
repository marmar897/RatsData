...
```{r interpolation calculation for inf / undefined / outlier data}

write.csv(df_The_Bronx_Neighborhood_Rats, "C:\\Users\\Admin\\Desktop\\df_The_Bronx_Neighborhoods.csv", row.names=FALSE)

write.csv(df_Brooklyn_Neighborhood_Rats, "C:\\Users\\Admin\\Desktop\\df_Brooklyn_Neighborhoods.csv", row.names=FALSE)

write.csv(df_Manhattan_Neighborhood_Rats, "C:\\Users\\Admin\\Desktop\\df_Manhattan_Neighborhoods.csv", row.names=FALSE)

write.csv(df_Queens_Neighborhood_Rats, "C:\\Users\\Admin\\Desktop\\df_Queens_Neighborhoods.csv", row.names=FALSE)

write.csv(df_Staten_Island_Neighborhood_Rats, "C:\\Users\\Admin\\Desktop\\df_Staten_Island_Neighborhoods.csv", row.names=FALSE)
