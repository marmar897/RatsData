...
df_Brooklyn <- rbind(df_Central_Brooklyn, df_Southwest_Brooklyn, df_Borough_Park, df_Southern_Brooklyn, df_Northwest_Brooklyn, df_Flatbush, df_East_NY_New_Lots, df_Greenpoint, df_Bushwick_Williamsburg, df_Sunset_Park)
