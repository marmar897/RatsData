...
df_The_Bronx <- df_NYC %>% filter(Borough == "BRONX")
  df_The_Bronx <- df_The_Bronx %>% filter(Zip%in%(10451:10475))
  
df_Brooklyn <- df_NYC %>% filter(Borough == "BROOKLYN")
  df_Brooklyn <- df_Brooklyn %>% filter(Zip%in%(11201:11256))
  
df_Manhattan <- df_NYC %>% filter(Borough == "MANHATTAN")
  df_Manhattan <- df_Manhattan %>% filter(Zip%in%(10001:10282))
  
df_Queens <- df_NYC %>% filter(Borough == "QUEENS")
  df_Queens <- df_Queens %>% filter(Zip%in%(11101:11697))
  
df_Staten_Island <- df_NYC %>% filter(Borough == "STATEN ISLAND")
  df_Staten_Island <- df_Staten_Island %>% filter(Zip%in%(10301:10314))
```
